...
public class NetWorkUtil {
    ...
    public static String getDeviceMac(Context context) {
        ...
        if (1 == getNetWorkType(context)) { // 有线网络
            strMac = getMac7UpAddress();
            return strMac;
        } else if (2 == getNetWorkType(context)) { // wifi网络
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                ...
                Log.e("=====", "6.0以上7.0以下");
                strMac = getMac67Address(context);
                return strMac;
            } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                if (!TextUtils.isEmpty(getMac7UpAddress())) {
                    Log.e("=====", "7.0以上1");
                    strMac = getMac7UpAddress();
                    return strMac;
     ...
     * @return
     */
    public static String getMac67Address(Context context) {
     ...
     * @return
     */
    public static String getMac7UpAddress() {
