...
public class TopStrategy implements Strategy {
    ...
    public void setDispatchAction(final ZoomImageView dispatchImageView, float totalAngle, float scale) {
        ...
        ObjectAnimator rotationAnimator = ObjectAnimator.ofFloat(dispatchImageView, "rotation", totalAngle - fullCycleCount * 360, 180);
        ...
        ValueAnimator topAnimator = ValueAnimator.ofInt(topMargin, 0);
